...
insert into user_data (id, name, first_name, last_name, password, status, email, created, updated, last_visit)
VALUES ('5', 'user1', 'User1', 'Test', '$2a$08$xiubgeYqFLLIhOYKAVEUM.dL578Ct3L93u8HxGLBKF8vYy9Wfi8n2',
        'ACTIVE', 'user1@gmail.com', current_timestamp, current_timestamp, current_timestamp);
insert into user_data (id, name, first_name, last_name, password, status, email, created, updated, last_visit)
VALUES ('10', 'user2', 'User2', 'Test', '$2a$08$xiubgeYqFLLIhOYKAVEUM.dL578Ct3L93u8HxGLBKF8vYy9Wfi8n2',
        'ACTIVE', 'user2@gmail.com', current_timestamp, current_timestamp, current_timestamp);
